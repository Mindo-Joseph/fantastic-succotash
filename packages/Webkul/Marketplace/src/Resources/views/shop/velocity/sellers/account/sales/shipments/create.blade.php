                ...
                <div class="sale-section">
                    <div class="section-content">
                        ...
                        <div class="form-group" :class="[errors.has('shipment[carrier_title]') ? 'has-error' : '']">
                            <label for="shipment[carrier_title]">{{ __('marketplace::app.shop.sellers.account.sales.shipments.carrier-title') }}</label>
                            <input type="text"  class="form-style" id="shipment[carrier_title]" name="shipment[carrier_title]" data-vv-as="&quot;{{ __('marketplace::app.shop.sellers.account.sales.shipments.carrier-title') }}&quot;"/>
                        ...
                        <div class="form-group" :class="[errors.has('shipment[track_number]') ? 'has-error' : '']">
                            <label for="shipment[track_number]">{{ __('marketplace::app.shop.sellers.account.sales.shipments.tracking-number') }}</label>
                            <input type="text" class="form-style" id="shipment[track_number]" name="shipment[track_number]" data-vv-as="&quot;{{ __('marketplace::app.shop.sellers.account.sales.shipments.tracking-number') }}&quot;"/>
