...
!(function (e) {
    ...
    if (
        (e(window).on("load", function () {
            setTimeout(function () {
                e(".loader_skeleton").fadeOut("slow"), e("body").css({ overflow: "auto" });
            }, 500),
...
body_event.on("click", ".theme-layout-version", function () {
    return (
        ...
        $(".theme-layout-version").hasClass("dark") ? ($(".theme-layout-version").text("Light"), $("body").addClass("dark")) : ($("#theme-dark").remove(), $(".theme-layout-version").text("Dark")),
        !1
    );
}),
    $(function () {
...
>>>>>>> d5df72171555d0ddcec08039de1fdfe2ee6c804d
