...
@section('content')
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home  text-center">
                    <img src="{{asset('front-assets/images/home-banner/1.jpg')}}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
            ...
            <div>
                <div class="home text-center">
                    <img src="{{asset('front-assets/images/home-banner/2.jpg')}}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="{{asset('front-assets/images/sub-banner1.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="{{asset('front-assets/images/sub-banner2.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                    ...
                    <div class="product-4 product-m no-arrow">
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front-assets/images/pro3/27.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front-assets/images/pro3/28.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                ...
                                <div class="front">
                                    <a href="product-page(no-sidebar).html">
                                        <img src="{{asset('front-assets/images/pro3/1.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                            alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front-assets/images/pro3/2.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="lable-block"><span class="lable3">new</span> <span class="lable4">on
                                        sale</span></div>
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front-assets/images/pro3/33.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front-assets/images/pro3/34.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front-assets/images/pro3/35.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front-assets/images/pro3/36.jpg')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="{{asset('front-assets/images/parallax/1.jpg')}}" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front-assets/images/blog/1.jpg')}}" class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front-assets/images/blog/2.jpg')}}" class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front-assets/images/blog/3.jpg')}}" class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front-assets/images/blog/4.jpg')}}" class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front-assets/images/blog/5.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                            alt="">
                                    </div>
                                    <span></span>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('front-assets/images/slider/2.jpg')}}" class="bg-img"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('front-assets/images/slider/3.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('front-assets/images/slider/4.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('front-assets/images/slider/9.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('front-assets/images/slider/6.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('front-assets/images/slider/7.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('front-assets/images/slider/8.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                    ...
                    <div class="slide-6 no-arrow">
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{asset('front-assets/images/logos/1.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
