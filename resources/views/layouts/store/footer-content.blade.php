    ...
    <section class="section-b-space light-layout py-xl-4 pt-4 pb-0">
        <div class="container">
            ...
            <div class="col-lg-3 col-md-6 mb-md-0 mb-3 text-right d-none">
                <div class="store-btn">
                    <a href="{{$client_preference_detail->ios_link??'#'}}"><img src="{{asset('front-assets/images/app-store.svg')}}" alt=""></a>
                    <a class="ml-2" href="{{$client_preference_detail->android_app_link??'#'}}"><img src="{{asset('front-assets/images/google-play.svg')}}" alt=""></a>
                </div>
