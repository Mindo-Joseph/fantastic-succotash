                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-4 text-right">
                            <!-- <button type="button" class="btn btn-info waves-effect waves-light openModal" data-toggle="modal" data-target="" data-backdrop="static" data-keyboard="false"><i class="mdi mdi-plus-circle mr-1"></i> Add Customer</button> -->
                        </div>
                    </div>
