<div class="row">
    <div class="col-md-12 card-box">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group" id="start_date_timeInput">
                    ...
                    {!! Form::text('start_date_time', $banner->start_date_time, ['class' => 'form-control downside datetime-datepicker', 'id' => 'start-datepicker' ]) !!}
        ...
        <div class="row category_vendor" style="display: none;">
            <div class="col-md-6 category_list" style="display: none;">
