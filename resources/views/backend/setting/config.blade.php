...
<div class="container-fluid">
    ...
    <form method="POST" action="{{route('configure.update', Auth::user()->code)}}">
        ...
        <div class="row">
            <div class="col-xl-11 col-md-offset-1">
                ...
                <div class="card-box">
                    <h4 class="header-title">Default Location</h4>
                    <p class="sub-header">Set website hyperlocal and the default location of store</p>
                    <div class="row mb-2">
                        <div class="col-sm-8">
            ...
            <div class="col-xl-11 col-md-offset-1">
                <div class="card-box"> 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3 switchery-demo">
                                <label for="fb_login" class="mr-3"><h5>Facebook Login</h5></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3 switchery-demo">
                                <label for="twitter_login" class="mr-3"><h5>Twitter Login</h5></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3 switchery-demo">
                                <label for="apple_login" class="mr-3"><h5>Apple Login</h5></label>
    ...
    <form method="POST" action="{{route('configure.update', Auth::user()->code)}}">
        ...
        <div class="row">
            <div class="col-xl-11 col-md-offset-1">
                <div class="card-box">
                    <h4 class="header-title">SMS Configuration</h4>
                    <p class="sub-header">
    ...
    <form method="POST" action="{{route('configure.update', Auth::user()->code)}}">
        ...
        <div class="row">
            <div class="col-xl-11 col-md-offset-1">
                <div class="card-box">
                    <h4 class="header-title">Mail Configuration</h4>
                    <p class="sub-header">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="mail_driver" id="mail_driver" placeholder="kjadsasd66asdas"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="mail_port" id="mail_port" placeholder="kjadsasd66asdas"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="mail_password" id="mail_password" placeholder="kjadsasd66asdas"
