...
@section('content')
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-12 tab-product pt-3">
                                    <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" id="active-orders-tab"
                                                data-toggle="tab" href="#active-orders" role="tab" aria-selected="true"><i
                                                ...
                                                @foreach ($orders as $key => $order)
                                                    <div class="col-12">
                                                        ...
                                                        <div class="row no-gutters order_data">
                                                            ...
                                                            <div class="col-md-3">
                                                                {{ $order->created_at->format('D M d, Y h:m A') }}</div>
                                                            <div class="col-md-3">
                                                                                ...
                                                                                <ul class="status_box mt-3 pl-0">
                                                                                    @foreach ($order->orderStatusVendor as $key => $status)
                                                                                        @if ($status->order_status_option_id == 1)
                                                                                            <li><img src="{{ asset('assets/images/order-icon.svg') }}"
                                                                                                    alt=""><label
                                                                                                    class="m-0 in-progress">Placed</label>
                                                                                            </li>
                                                                                        @endif
                                                                                        @if ($status->order_status_option_id == 2)
                                                                                            <li><img src="{{ asset('assets/images/payment_icon.svg') }}"
                                                                                                    alt=""><label
                                                                                                    class="m-0 in-progress">Accepted</label>
                                                                                            </li>
                                                                                        @endif
                                                                                        @if ($status->order_status_option_id == 3)
                                                                                            <li><img src="{{ asset('assets/images/customize_icon.svg') }}"
                                                                                                    alt=""><label
                                                                                                    class="m-0 in-progress">Processing</label>
                                                                                            </li>
                                                                                        @endif
                                                                                        @if ($status->order_status_option_id == 4)
                                                                                            <li><img src="{{ asset('assets/images/driver_icon.svg') }}"
                                                                                                    alt=""><label
                                                                                                    class="m-0 in-progress">Out
                                                                                                    For Delivery</label>
                                                                                            </li>
                                                                                        @endif
                                                                                        @if ($status->order_status_option_id == 5)
                                                                                            <li><img src="{{ asset('assets/images/driver_icon.svg') }}"
                                                                                                    alt=""><label
                                                                                                    class="m-0 in-progress">Delivered</label>
                                                                                            </li>
                                                                                        @endif
                                                                                    @endforeach
                                                                                </ul>
                                                                                    ...
                                                                                    @foreach ($vendor->products as $product)
                                                                                        @if ($vendor->vendor_id == $product->vendor_id)
                                                                                            <li class="text-center">
                                                                                                <img src="{{ $product->image['proxy_url'] . '74/100' . $product->image['image_path'] }}"
                                                                                                    alt="">
                                                                                                <span
                                                                                                    class="item_no position-absolute">x{{ $product->quantity }}</span>
                                                                                                <?php
                                                                                                /* ?><label
                                                                                                    class="items_name">{{ $product->product_name }}</label><?php */
                                                                                                ?>
                                                                                                <label
                                                                                                    class="items_price">${{ $product->price }}</label>
                                                                                            </li>
                                                                                        @endif
                                                                                    @endforeach
                                                                                </ul>
                                                                            ...
                                                                            <div class="col-md-5 mt-md-0 mt-sm-2">
                                                                                <ul class="price_box_bottom m-0 p-0">
                                                                                    <li
                                                                                        ...
                                                                                        <label class="m-0">Product
                                                                                            Total</label>
                                                                                        <span>${{ number_format($order->total_amount, 2) }}</span>
                                                                                    </li>
                                                                                    <li
                                                                                        class="d-flex align-items-center justify-content-between">
                                                                                        <label class="m-0">Coupon
                                                                                            (10%)</label>
                                                                                        <span>${{ $order->total_discount ? number_format($order->total_discount, 2) : 0.0 }}</span>
                                                                                    </li>
                                                                                    <li
                                                                                        class="d-flex align-items-center justify-content-between">
                                                                                        <label class="m-0">Delivery
                                                                                            Fee</label>
                                                                                        <span>${{ $order->total_delivery_fee ? number_format($order->total_delivery_fee, 2) : 0.0 }}</span>
                                                                                    </li>
                                                                                    <li
                                                        ...
                                                        /* ?><div class="row">
                                                            <div class="col-md-9 mb-3">
                                                                <a href="#"
                                                                    class="row order_detail order_detail_data align-items-top pb-3 card-box no-gutters mb-0 h-100">
                                                                    <span class="left_arrow pulse"></span>
                                                                    <div class="col-5 col-sm-3">
                                                                        ...
                                                                        <ul class="status_box mt-3 pl-0">
                                                                            ...
                                                                            <li><img src="{{ asset('assets/images/driver_icon.svg') }}"
                                                                                    alt=""><label
                                                                                    class="m-0 in-progress">Assigned</label>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                    <div class="col-7 col-sm-4">
                                                                        <ul
                                                                            ...
                                                                            <li class="text-center">
                                                                                <img src="{{ asset('assets/images/order-icon.svg') }}"
                                                                                    alt="">
                                                                                <span
                                                                                    class="item_no position-absolute">x2</span>
                                            ...
                                            <div class="row">
                                                                                        ...
                                                                                        @if ($vendor->vendor_id == $product->vendor_id)
                                                                                            <li class="text-center">
                                                                                                ...
                                                                                                <form
                                                                                                    ...
                                                                                                    @csrf
                                                                                                    <input type="hidden"
                                                                                                        name="order_vendor_product_id"
                                                                                                        value="143">
                                                                                                    <textarea
                                                                                                        class="form-control"
                                                                                                        maxlength="500"
                                                                                                        name="hidden_review"
                                                                                                        hidden>{{ $rating_details->review ?? '' }}</textarea>
                                                                                                    <div
                                                                                                        class="rating-form">
                                                                                                        <fieldset
                                                                                                            class="form-group">
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    type="radio"
                                                                                                                    value="5"
                                                                                                                    {{ $rating_details->rating == 5 ? 'checked' : '' }} />
                                                                                                                <label
                                                                                                                    for="rating-5"
                                                                                                                    data-value="5">
                                                                                                                    <span
                                                                                                                ...
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    type="radio"
                                                                                                                    value="4"
                                                                                                                    {{ $rating_details->rating == 4 ? 'checked' : '' }} />
                                                                                                                <label
                                                                                                                    for="rating-4"
                                                                                                                    data-value="4">
                                                                                                                    <span
                                                                                                                ...
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    type="radio"
                                                                                                                    value="3"
                                                                                                                    {{ $rating_details->rating == 3 ? 'checked' : '' }} />
                                                                                                                <label
                                                                                                                    for="rating-3"
                                                                                                                    data-value="3">
                                                                                                                    <span
                                                                                                                ...
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    type="radio"
                                                                                                                    value="2"
                                                                                                                    {{ $rating_details->rating == 2 ? 'checked' : '' }} />
                                                                                                                <label
                                                                                                                    for="rating-2"
                                                                                                                    data-value="2">
                                                                                                                    <span
                                                                                                                ...
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    type="radio"
                                                                                                                    value="1"
                                                                                                                    {{ $rating_details->rating == 1 ? 'checked' : '' }} />
                                                                                                                <label
                                                                                                                    for="rating-1"
                                                                                                                    data-value="1">
                                                                                                                    <span
                                                                                                ...
                                                                                                <label
                                                                                                    class="items_price rating-star d-bloack update-rating"
                                                ...
                                                /* ?><div class="col-12">
                                                    ...
                                                    <div class="row no-gutters order_data mb-lg-2">
                                                        ...
                                                        <div class="col-md-3">
                                                            <p class="ellipsis" data-toggle="tooltip" data-placement="top"
                                                                title="RTC Cross Road, P & T Colony, Jawahar Nagar, Himayatnagar, Hyderabad, Telangana, India">
                                                                RTC Cross Road, P & T Colony, Jawahar Nagar, Himayatnagar,
                                                        ...
                                                        <div class="col-md-9 mb-3">
                                                            <a href="#"
                                                                    ...
                                                                    <ul
                                                                        ...
                                                                        <li class="text-center">
                                                                            ...
                                                                            <span
                                                                                class="item_no position-absolute">x2</span>
                                                                            <label class="items_price">$20.00</label>
                                                                            <label class="items_price rating-star"
                                                                                data-toggle="modal"
                                                                                data-target="#product_rating"><i
                                                                                    class="fa fa-star-o"></i></label>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                ...
                                                                <div class="col-12 text-md-right mt-3">
                                                                    <label class="rate-btn btn btn-solid m-0"
                                                                        data-toggle="modal"
                                                                        data-target="#return_order">Return</label>
                                                                </div>
                                                            </a>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
    ...
    <div class="modal fade order_detail" id="order-details" tabindex="-1" aria-labelledby="order-detailsLabel"
        aria-hidden="true">
                ...
                <div class="modal-body pt-0">
                    <ul class="d-inline-flex align-items-center p-0">
                        <li class="product-icon">
                            <img src="http://local.myorder.com/assets/images/products/product-1.png" alt="product-img"
                                height="50">
                        </li>
                    ...
                    <div class="table-responsive">
                        <table class="table detail-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <p class="saving-txt d-flex align-items-center justify-content-between m-0">
                                            <span>Your total savings</span><span>₹25.63</span></p>
                                    </td>
                                </tr>
                            </tbody>
                            <tfoot>
                                ...
                                <tbody>
                                    <tr>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <label class="order-items d-flex" for="item_one">
                                                    <div class="item-img mx-1">
                                                        <img src="https://imgproxy.royoorders.com/insecure/fill/600/800/sm/0/plain/https://s3.us-west-2.amazonaws.com/royoorders2.0-assets/prods/NVtOSeR3oh8PW8JPOMCHj4uIQuHUR49M5xqSQMoU.jpg"
                                                            alt="">
                                                    </div>
                                        ...
                                        <td class="order_address">
                                            <p>RTC Cross Road, P & T Colony, Jawahar Nagar, Himayatnagar, Hyderabad,
                                                Telangana, India</p>
                                        </td>
                                        <td>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(document).delegate(".update-rating", "click", function() {
                ...
                if (typeof addressID !== 'undefined' && addressID !== false) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status == 'success') {
                                ...
                                let add_address_template = _.template($('#add_address_template')
                                    .html());
                                $("#add_edit_address .modal-content").append(
                    ...
                    $("#add_edit_address .modal-content").append(add_address_template({
                        title: 'Add'
                    }));
                    initialize();
                }
