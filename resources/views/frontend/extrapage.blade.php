                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="file file--upload">
                                    ...
                                    <input id="input-file" type="file" name="upload_logo" accept="image/*" onchange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])">
                                </div>
                            </div>
                            <div class="col-md-8 mb-3">
                                ...
                                <div class="file file--upload">
                                    ...
                                    <input id="input-file-banner" type="file" name="upload_banner" accept="image/*" onchange="document.getElementById('upload_banner_preview').src = window.URL.createObjectURL(this.files[0])">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
